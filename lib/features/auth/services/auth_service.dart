...
import 'package:llunkei_test_app/constants/error_handling.dart';
...
import 'package:llunkei_test_app/models/user.dart';
      ...
      httpErrorHandle(
        ...
        onSuccess: () async {
          ...
          await prefs.setString(
              'x-auth-token',
              jsonDecode(res.body)[
                  'token']); //need this to get data of user, their token
